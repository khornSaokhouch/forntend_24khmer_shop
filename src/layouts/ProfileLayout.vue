...
<template>
  <div
    class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative"
  >
    <!-- Decorative background elements -->
    <div class="absolute inset-0 pointer-events-none overflow-hidden">
      <div
        class="absolute top-20 left-10 w-40 h-40 bg-blue-200/50 rounded-full blur-3xl animate-pulse"
      ></div>
      <div
        class="absolute bottom-20 right-10 w-56 h-56 bg-cyan-200/50 rounded-full blur-3xl animate-pulse delay-1000"
      ></div>
    </div>
    ...
    <div class="relative z-10 flex flex-col min-h-screen">
      ...
      <div class="flex flex-1 container mx-auto py-6 gap-6">
        ...
        <aside class="w-72 flex-shrink-0">
          <div
            class="bg-white/80 backdrop-blur-sm border border-blue-100 rounded-2xl p-6 flex flex-col shadow-lg h-full"
          >
            <!-- User info -->
            <div class="mb-8 flex items-center space-x-4">
              <div
                class="relative w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 p-0.5"
              >
                <div
              ...
              <div>
                ...
                <p class="text-slate-600 text-sm capitalize">
                  {{ authStore.user?.role }}
                </p>
              </div>
            </div>
            ...
            <nav class="flex-1 flex flex-col space-y-2">
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M12 8c-1.657 0-3 1.343-3 3v3h6v-3c0-1.657-1.343-3-3-3zM6 21h12a2 2 0 002-2v-5a2 2 0 00-2-2H6a2 2 0 00-2 2v5a2 2 0 002 2z"
                  ></path>
                </svg>
                <span>Payments</span>
              </router-link>
              ...
              <router-link
                ...
                :class="[
                  'group flex items-center space-x-3 px-4 py-3 rounded-xl transition-colors duration-200',
                  isActive('/profile/reset-password')
                    ? '!bg-gradient-to-r !from-blue-100 !to-cyan-100 !text-blue-700 font-semibold shadow-inner'
                    : 'text-slate-600 hover:bg-slate-100',
                ]"
              >
                ...
                >
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M12 11c1.104 0 2 .896 2 2v2a2 2 0 11-4 0v-2c0-1.104.896-2 2-2zM4 11v2a8 8 0 0016 0v-2M4 11a8 8 0 0116 0"
                  ></path>
                </svg>
              ...
              >
                ...
                >
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M12 8v4l3 3M12 20a8 8 0 100-16 8 8 0 000 16z"
                  ></path>
                </svg>
                <span>History</span>
              </router-link>
        ...
        <main class="flex-1">
          <div
            class="bg-white/80 backdrop-blur-sm border border-blue-100 rounded-2xl min-h-full shadow-lg"
          >
            <router-view />
          </div>
        </main>
    ...
    <transition name="fade-scale">
      ...
      >
        ...
        ></div>
        <div
          class="relative bg-white/95 backdrop-blur-xl border border-blue-100 rounded-2xl p-8 max-w-md w-full mx-auto shadow-2xl"
        >

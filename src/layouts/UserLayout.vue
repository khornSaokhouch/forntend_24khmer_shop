<template>
  <div class="min-h-screen flex flex-col font-sans text-slate-800 relative selection:bg-indigo-100 selection:text-indigo-700 bg-white">
    
    <!-- Optional: Remove the dotted background entirely -->
